...
public class BookingCommand {
    ...
    public BookingCommand(Booking booking) {
        ...
        if (booking.getDate() != null) this.date = booking.getDate();
        if (booking.getStartTime() != null) this.startTime = booking.getStartTime().toString();
        if (booking.getEndTime() != null) this.endTime = booking.getEndTime().toString();
    ...
    public Booking toBooking() {
     ...
     java.sql.Time xEndTime = java.sql.Time.valueOf(endTime+":00");
        ...
        booking.setStartTime(xStartTime);
        booking.setEndTime(xEndTime);
